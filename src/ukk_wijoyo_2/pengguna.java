...
public class pengguna extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 110, 151, -1));
        ...
        jPanel1.add(akses, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 80, 149, -1));
        ...
        jPanel1.add(username, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 80, 150, -1));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ukk_wijoyo_2/img/icons8_User_24px.png"))); // NOI18N
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 30, -1, 40));
    ...
    private void usersMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_usersMouseClicked
        ...
        String diklik = (users.getModel().getValueAt(row, 0).toString());
        String sql = "SELECT * FROM user WHERE id_user='"+diklik+"'";
        ...
        try {
            ...
            if((rs.next())){
                String tambah1 = rs.getString("id_user");
                id.setText(tambah1);
                String tambah2 = rs.getString("username");
                username.setText(tambah2);
                String tambah4 = rs.getString("password");
                password.setText(tambah4);
                String tambah5 = rs.getString("nama");
                nama.setText(tambah5);
                String tambah6 = rs.getString("akses");
                akses.setSelectedItem(tambah6);
            }
        } catch (SQLException ex) {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try {
            String check = "SELECT * FROM user WHERE id_user='"+id.getText()+"'";
            pst = conn.prepareStatement(check);
            rs = pst.executeQuery();
            if((!rs.next())){

                if (!id.getText().isEmpty() && !nama.getText().isEmpty() && !password.getText().isEmpty() && !username.getText().isEmpty()){
                        String query = "INSERT INTO user (id_user,username,password,nama,akses) value(?,?,?,?,?)";
                    pst = conn.prepareStatement(query);

                    pst.setString(1, id.getText());
                    pst.setString(2, username.getText());

                    String value=akses.getSelectedItem().toString();
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE user SET username=?, password=?, nama=?, akses=? where id_user='"+id.getText()+"'";
            pst = conn.prepareStatement(sql);
