...
public class kereta extends javax.swing.JFrame {
    ...
    private void show_data(){
        String perintah = "SELECT * FROM kereta";
        try {
    ...
    private void initComponents() {
        ...
        kelas.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ekonomi", "bisnis", "eksekutif" }));
        jPanel1.add(kelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 80, 149, -1));

        kereta.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(kereta);
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ukk_wijoyo_2/img/icons8_Train_24px.png"))); // NOI18N
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, -1, 40));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 110, 370));
...
clear();
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
           ...
           try {
                String check = "SELECT * FROM kereta WHERE id_kereta='"+id.getText()+"'";
                pst = conn.prepareStatement(check);
                rs = pst.executeQuery();    
                if((!rs.next())){
                    
                    if (!id.getText().isEmpty() && !nama.getText().isEmpty() && !jumlah.getText().isEmpty()){
                    String query = "INSERT INTO kereta (id_kereta,nama_kereta,class,deskripsi,jumlah_seat,harga) value(?,?,?,?,?,?)";
    ...
    private void keretaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_keretaMouseClicked
        // TODO add your handling code here:
        int row = kereta.getSelectedRow();
        String diklik = (kereta.getModel().getValueAt(row, 0).toString());
        String sql = "SELECT * FROM kereta WHERE id_kereta='"+diklik+"'";
            ...
            try {
                ...
                rs = pst.executeQuery();
                 ...
                 if((rs.next())){
                     String tambah1 = rs.getString("id_kereta");
                     id.setText(tambah1);
                     String tambah2 = rs.getString("nama_kereta");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE kereta SET nama_kereta=?, class=?, deskripsi=?, jumlah_seat=?, harga=? where id_kereta='"+id.getText()+"'";
            pst = conn.prepareStatement(sql);
    ...
    private javax.swing.JTable kereta;
